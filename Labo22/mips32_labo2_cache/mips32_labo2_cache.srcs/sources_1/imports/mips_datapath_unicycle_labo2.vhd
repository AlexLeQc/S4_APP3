...
generic (
	g_useInstructionMem   : boolean := false;
	g_useInstructionDram  : boolean := true;
...
architecture Behavioral of mips_datapath_unicycle is
	...
	Port ( 
        ...
        i_dram_ReadDataAddress	: in std_logic_vector(31 downto 2);
        i_dram_WriteDataAddress	: in std_logic_vector(31 downto 0);
		i_dram_ReadRequest	: in std_logic;
		i_dram_WriteRequest	: in std_logic;
		o_dram_WordIndexSel : out std_logic_vector(2 downto 0); -- supports bursts of 2, 4 and 8 words, and single words
		o_dram_ReadAck 		: out std_logic;
        o_dram_WriteAck     : out std_logic;
		o_dram_ReadDone		: out std_logic;
		o_dram_ReadData		: out std_logic_vector (31 downto 0);
		i_dram_WriteData	: in std_logic_vector (31 downto 0);

		o_bram_MemRead 		: out std_logic;
		o_bram_MemWrite 	: out std_logic;
		o_bram_Addresse 	: out std_logic_vector (31 downto 0);
		o_bram_WriteData	: out std_logic_vector (31 downto 0);
		i_bram_ReadData 	: in std_logic_vector (31 downto 0)
	);
	end component;
	...
	Port ( 
		clk 				: in std_logic;
		i_cpu_ReadRequest 	: in std_logic;
		i_cpu_WriteRequest 	: in std_logic;
		o_cpu_ReadAckow		: out std_logic;
		o_cpu_WriteAckow	: out std_logic;
		i_cpu_Addresse		: in std_logic_vector (31 downto 0);
		i_cpu_WriteData		: in std_logic_vector (31 downto 0);
		o_cpu_ReadData		: out std_logic_vector (31 downto 0);
		
		-- vers le controlleur de mémoire
		o_dram_ReadDataAddress	: out std_logic_vector(31 downto 2);
		o_dram_ReadRequest	: out std_logic;
		o_dram_WriteRequest	: out std_logic;
		i_dram_WordIndexSel : in std_logic_vector(2 downto 0); -- supports bursts of 2, 4 and 8 words, and single words
		i_dram_ReadAck 		: in std_logic;
        i_dram_WriteAck 	: in std_logic;
		i_dram_ReadDone		: in std_logic;
		i_dram_ReadData		: in std_logic_vector (31 downto 0);
        o_dram_WriteDataAddress : out std_logic_vector (31 downto 0);
		o_dram_WriteData	: out std_logic_vector (31 downto 0)
	);
	end component;
	...
	signal s_InstructionStall	: std_logic;
	signal s_DataStall          : std_logic;
...
MemInstructionsDRAM: if (g_useInstructionDram = true) generate
	signal s_dram_ReadDataAddress	: std_logic_vector(31 downto 2);
	signal s_dram_WriteDataAddress	: std_logic_vector(31 downto 0);
	signal s_dram_ReadRequest	: std_logic;
	signal s_dram_WriteRequest	: std_logic;
	signal s_dram_WordIndexSel 	: std_logic_vector(2 downto 0); -- supports bursts of 2, 4 and 8 words, and single words
	signal s_dram_ReadAck 		: std_logic;
	signal s_dram_WriteAck 		: std_logic;
	signal s_dram_ReadDone		: std_logic;
	signal s_dram_ReadData		: std_logic_vector (31 downto 0);
	signal s_dram_WriteData		: std_logic_vector (31 downto 0);
	
	signal s_bram_MemRead 	: std_logic;
	signal s_bram_MemWrite 	: std_logic;
	signal s_bram_Addresse 	: std_logic_vector (31 downto 0);
	signal s_bram_WriteData	: std_logic_vector (31 downto 0);
	signal s_bram_ReadData 	: std_logic_vector (31 downto 0);
		
	signal s_cpu_ReadAckow	: std_logic;
begin
	...
	--Faire en sorte que ca stop si on a un call
	--Il faut attendre 10 coup de clock avant que lordi envoie des trucs
...
MemDonneesCache: if (g_useDataCache = true) generate
	...
	signal s_cpu_ReadAckow	: std_logic;
	signal s_cpu_WriteAckow	: std_logic;
begin
