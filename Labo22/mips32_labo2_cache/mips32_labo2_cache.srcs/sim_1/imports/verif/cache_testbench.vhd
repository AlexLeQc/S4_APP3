...
architecture Behavioral of cache_testbench is
	...
	type t_sequence_cache_element is record
		mode     : std_logic;
		adresse  : std_logic_vector (31 downto 0);
	...
	signal s_cpu_ReadRequest 	: std_logic := '0';
	signal s_cpu_WriteRequest 	: std_logic := '0';
	signal s_cpu_ReadAckow		: std_logic;
	signal s_cpu_WriteAckow		: std_logic;
	signal s_cpu_Addresse		: std_logic_vector (31 downto 0);
	signal s_cpu_WriteData		: std_logic_vector (31 downto 0);
	signal s_cpu_ReadData		: std_logic_vector (31 downto 0);
