...
begin
    ...
    s_InstructionStall      <= <<signal .mips_unicycle_tb.dut.inst_Controleur.i_InstrStall : std_logic>>;
    s_DataStall             <= <<signal .mips_unicycle_tb.dut.inst_Datapath.s_DataStall : std_logic>>;
...
process(show_SeenInstruction, s_DataStall)
    alias s_RegT : std_logic_vector(4 downto 0) is  s_Instruction(20 downto 16);
    alias s_RegS : std_logic_vector(4 downto 0) is  s_Instruction(25 downto 21);
begin
