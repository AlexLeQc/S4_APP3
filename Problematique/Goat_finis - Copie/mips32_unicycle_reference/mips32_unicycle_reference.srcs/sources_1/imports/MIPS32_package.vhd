...
package MIPS32_package is
    ...
    constant ALU_MIV  : std_logic_vector( 3 downto 0 ) := "0101";
    ...
    constant ALUF_MIV       : std_logic_vector( 5 downto 0 ) := "101100";
    constant ALUF_ADDV      : std_logic_vector( 5 downto 0 ) := "101101";
    ...
    type RAM_Vector is array (natural range <>) of std_logic_vector (127 downto 0);
...
begin
	...
	case alu_funct is
        ...
        when ALU_ADDV =>
            CurrentAction := sim_alu_ADDV;
        when ALU_MIV =>
            CurrentAction := sim_alu_MIV;
		when others =>
