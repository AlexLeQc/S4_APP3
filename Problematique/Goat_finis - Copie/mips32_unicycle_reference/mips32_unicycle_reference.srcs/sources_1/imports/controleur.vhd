...
Port (
    ...
    o_RegWrite_Vector : out std_logic;
...
begin
	...
	o_RegWrite_vector <= '1' when i_Op = ALU_ADDV or 
								  i_Op = OP_LWV
						else '0';
	
	o_RegDst 		<= '1' when i_Op = OP_Rtype;
	...
	o_MemtoRegWide  <= '1' when i_Op = OP_LWV else '0';
