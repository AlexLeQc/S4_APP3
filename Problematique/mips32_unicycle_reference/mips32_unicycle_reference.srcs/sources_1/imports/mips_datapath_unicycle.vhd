...
Port ( 
    ...
    signal s_reg_data2_Wide   : std_logic_vector(127 downto 0);
    ...
    signal s_MemoryReadDate_Wide   : std_logic_vector(127 downto 0);
...
port map ( 
	...
	i_WE         => i_MemWriteWide,
	o_RS1_DAT    => s_reg_data1_Wide,
	o_RS2_DAT    => s_reg_data2_Wide
	);
...
Port map( 
	...
	i_WriteDataWide => s_reg_data2_Wide, 	
    o_ReadDataWide => s_MemoryReadDate_Wide		
