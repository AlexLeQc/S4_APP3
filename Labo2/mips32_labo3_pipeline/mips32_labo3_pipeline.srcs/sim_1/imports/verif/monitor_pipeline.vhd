...
architecture Behavioral of monitor_pipeline is
	...
	signal show_EX_alu_unsupported	: std_logic;
	
	signal flag_branch				: std_logic;
	signal flag_jump				: std_logic;
	signal flag_flush				: std_logic;
	signal flag_bubble				: std_logic;
...
begin
	...
	show_EX_alu_unsupported	<= <<signal .mips_pipeline_tb.dut.inst_Datapath.inst_alu.s_unsupported : std_logic>>;
	show_EX_alu_action 		<= f_DisplayAluAction(<<signal .mips_pipeline_tb.dut.inst_Datapath.inst_alu.i_alu_funct : std_logic_vector>>);


IF_EncapsulerExtraction: block
	signal s_Instruction		: std_logic_vector (31 downto 0);
begin
	s_Instruction		<= <<signal .mips_pipeline_tb.dut.inst_Datapath.s_Instruction : std_logic_vector>>;
...
ID_EncapsulerExtraction: block
	signal s_Instruction		: std_logic_vector (31 downto 0);
begin
	s_Instruction		<= <<signal .mips_pipeline_tb.dut.inst_Datapath.r_IF_ID_Instruction : std_logic_vector>>;
...
begin
	...
	clk			<= <<signal .mips_pipeline_tb.dut.inst_Datapath.clk : std_logic>>;
	s_bubble	<= <<signal .mips_pipeline_tb.dut.inst_Datapath.s_InsertBubble : std_logic>>;
